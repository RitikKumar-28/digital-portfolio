...
const Skills = () => {
    const skillCategories = [
        ...
        },
        {
            ...
            skills: ['Burp Suite', 'Metasploit', 'Nmap', 'Wireshark', 'Nessus', 'Postman', 'OWASP Top 10', 'NIST Framework', 'MITRE ATT&CK', 'ISO/IEC 27001']
        },
        {
            title: 'Platforms & OS',
            icon: <Cpu size={24} />,
                ...
                <div className="skills-grid">
                    {skillCategories.map((category, index) => (
                        <div className="uiverse-box" key={index}>
                            <motion.div
                                className="skill-card uiverse-box-inner glass"
